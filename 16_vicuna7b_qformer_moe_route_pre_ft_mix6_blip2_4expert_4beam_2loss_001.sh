...
# start: lizrun start -c "/mnt/pfs-guan-ssai/nlu/wanghanzi/multimodal/PromptMoE/16_vicuna7b_qformer_moe_route_pre_ft_mix6_blip2_4expert_4beam_2loss_001.sh" -n 1 -g 4 -j add-pre-mix6-5e5-4ex4b-001 -i reg-ai.chehejia.com/ssai/lizr/cu118/py310/pytorch:2.0.1-multinode-nccl -p eval
# PATH_ORI=${0%/*}
...
run:
  ...
  seed: 42
  output_dir: "/mnt/pfs-guan-ssai/nlu/wanghanzi/experiments/blip2/vicuna7b/qformer_mode_cls/mix_coco_gqa_ao_cocap_textcap_raw_QformerMoE_PRE_lnout_lr5e5_4ex4b_2loss_001_top6layer_textinqf_10epo_0408/"
