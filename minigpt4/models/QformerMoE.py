...
class BertLayer(nn.Module): 
    ...
    def forward(
        ...
        if query_length > 0:
            ...
            layer_output = self.feed_forward_query_moe(moe_ffn_attention_input, moe_ffn_attention_mask) # layer_output, gate_loss
            ...
            if attention_output.shape[1] > query_length:
                ...
                layer_output = (torch.cat([layer_output[0], layer_output_text], dim=1), layer_output[1])
        else:
...
class BertMoELMHeadModel(BertPreTrainedModel):
