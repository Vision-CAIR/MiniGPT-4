...
# start: lizrun start -c "/mnt/pfs-guan-ssai/nlu/wanghanzi/multimodal/PromptMoE/5_vicuna7b_qformer_moe_post_ft_mix_aokvqa_cap_blip2_3expert_top1_005_2loss.sh" -n 1 -j post-lora-ao-cap-3e1-5e5-15ep-0310 -i reg-ai.chehejia.com/ssai/lizr/cu118/py310/pytorch:2.0.1-multinode-nccl -p basev
...
run:
  ...
  seed: 42
  output_dir: "/mnt/pfs-guan-ssai/nlu/wanghanzi/experiments/blip2/vicuna7b/qformer_moe_post/lora_mix_coco_gqa_aokvqa_raw_QformerMoE_linear_gate_lnout_lr5e5_3ex_top1_2loss_005_top6layer_textinqf_15epo_0309/"
