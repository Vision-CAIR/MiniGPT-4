...
# start: lizrun start -c "/mnt/pfs-guan-ssai/nlu/wanghanzi/multimodal/PromptMoE/15_vicuna7b_qformer_moe_post_ft_mix6_blip2_4expert_top1_2loss_001.sh" -n 1 -g 4 -j add-post-mix6-5e5-4ex1-001 -i reg-ai.chehejia.com/ssai/lizr/cu118/py310/pytorch:2.0.1-multinode-nccl -p base
# PATH_ORI=${0%/*}
...
run:
  ...
  seed: 42
  output_dir: "/mnt/pfs-guan-ssai/nlu/wanghanzi/experiments/blip2/vicuna7b/qformer_mode_cls/mix_coco_gqa_ao_cocap_textcap_raw_QformerMoE_Post_lnout_lr5e5_4extop1_2loss_001_top6layer_textinqf_10epo_0404/"
