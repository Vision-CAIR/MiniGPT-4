...
# start: lizrun start -c "/mnt/pfs-guan-ssai/nlu/wanghanzi/multimodal/PromptMoE/5_vicuna7b_qformer_ft_mix_aokvqa_cap_blip2_lora.sh" -n 1 -j base-lora-ao-cap-1e1-15ep-0310 -i reg-ai.chehejia.com/ssai/lizr/cu118/py310/pytorch:2.0.1-multinode-nccl -p basev
...
run:
  ...
  seed: 42
  output_dir: "/mnt/pfs-guan-ssai/nlu/wanghanzi/experiments/blip2/vicuna7b/qformer_moe_post/lora_mix_coco_gqa_aokvqa_raw_QformerMoE_lr5e5_textinqf_15epo_0309/"
