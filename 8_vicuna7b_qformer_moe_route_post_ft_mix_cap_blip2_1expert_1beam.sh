...
# start: lizrun start -c "/mnt/pfs-guan-ssai/nlu/wanghanzi/multimodal/PromptMoE/8_vicuna7b_qformer_moe_route_post_ft_mix_cap_blip2_1expert_1beam.sh" -n 1 -j r-post-mix-cap-1e1b-0303 -i reg-ai.chehejia.com/ssai/lizr/cu118/py310/pytorch:2.0.1-multinode-nccl -p basev
# PATH_ORI=${0%/*}
...
run:
  ...
  seed: 42
  output_dir: "/mnt/pfs-guan-ssai/nlu/wanghanzi/experiments/blip2/vicuna7b/qformer_moe_route/mix_coco_gqa_cap_raw_QformerMoE_lr5e5_1ex1_capinstruction_textinqf_6epo_0303/"
