...
# start: lizrun start -c "/mnt/pfs-guan-ssai/nlu/wanghanzi/multimodal/PromptMoE/5_vicuna7b_qformer_ft_mix_blip2_1expert_top1_1loss.sh" -n 1 -j qf-mix-1e1-lr-0112 -g 8 -i reg-ai.chehejia.com/ssai/lizr/cu118/py310/pytorch:2.0.1-multinode-nccl -p default
# PATH_ORI=${0%/*}
