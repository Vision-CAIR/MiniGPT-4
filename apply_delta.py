...
def apply_delta_low_cpu_mem(base_model_path, target_model_path, delta_path):
    print(f"Loading the delta tokenizer from {delta_path}")
    delta_tokenizer = AutoTokenizer.from_pretrained(delta_path, use_fast=False)

    print(f"Loading the delta config from {delta_path}")
...
if __name__ == "__main__":
    ...
    print("base", args.base_model_path)
    print("target", args.target_model_path)
    print("delta", args.delta_path)
    if args.low_cpu_mem:
