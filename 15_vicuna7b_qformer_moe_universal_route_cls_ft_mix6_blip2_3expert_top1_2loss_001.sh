...
# start: lizrun start -c "/mnt/pfs-guan-ssai/nlu/wanghanzi/multimodal/PromptMoE/15_vicuna7b_qformer_moe_universal_route_cls_ft_mix6_blip2_3expert_top1_2loss_001.sh" -n 1 -g 4 -j add-pre-mix6-5e5-3ex3b-001 -i reg-ai.chehejia.com/ssai/lizr/cu118/py310/pytorch:2.0.1-multinode-nccl -p base
# PATH_ORI=${0%/*}
