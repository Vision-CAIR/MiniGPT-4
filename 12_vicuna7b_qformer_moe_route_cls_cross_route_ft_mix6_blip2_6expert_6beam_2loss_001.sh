...
# start: lizrun start -c "/mnt/pfs-guan-ssai/nlu/wanghanzi/multimodal/PromptMoE/12_vicuna7b_qformer_moe_route_cls_cross_route_ft_mix6_blip2_6expert_6beam_2loss_001.sh" -n 1 -g 4 -j cls-cross-route-mix6-001-6ex6b -i reg-ai.chehejia.com/ssai/lizr/cu118/py310/pytorch:2.0.1-multinode-nccl -p base2
# PATH_ORI=${0%/*}
...
model:
  ...
  moebert_route_method: 'cls-cross-route'
  moebert_load_balance: 0.01
  moebert_expert_num: 6
  moebert_num_beams: 6
...
run:
  ...
  seed: 42
  output_dir: "/mnt/pfs-guan-ssai/nlu/wanghanzi/experiments/blip2/vicuna7b/qformer_mode_cls/mix_coco_gqa_ao_cocap_textcap_raw_QformerMoE_CLS_Cross_lnout_lr5e5_6ex6b_2loss_001_top6layer_textinqf_10epo_0401/"
