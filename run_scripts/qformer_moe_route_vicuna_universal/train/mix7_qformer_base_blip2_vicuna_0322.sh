...
python -m torch.distributed.run --nproc_per_node=${GPUS_PER_NODE} --master_port=${MASTER_PORT} train.py --cfg-path minigpt4/projects/qformer_moe_route_universal_vicuna/train/mix7_base_vicuna7b_qformer_blip2.yaml
