...
# start: lizrun start -c "/mnt/pfs-guan-ssai/nlu/wanghanzi/multimodal/PromptMoE/6_vicuna7b_qformer_moe_ft_llava_mix_blip2_1expert_top1_3loss.sh" -n 1 -j blip2-vi-qfmoe-mixto-1e1-1128 -i reg-ai.chehejia.com/ssai/lizr/cu118/py310/pytorch:2.0.1-multinode-nccl -p default
...
run:
  ...
  seed: 42
  output_dir: "/mnt/pfs-guan-ssai/nlu/wanghanzi/experiments/blip2/vicuna7b/qformer_moe/mix_coco_gqa_together_raw_QformerMoE_train_qf_train_qt_linear_gate_1ex_top1_textinqf_epo3_1128/"
