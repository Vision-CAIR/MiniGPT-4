...
# lizrun start -c "/mnt/pfs-guan-ssai/nlu/wanghanzi/multimodal/PromptMoE/7_vicuna7b_qformer_moe_ft_mix_blip2_5expert_top1_1loss_data_balance.sh" -n 1 -j blip2-vicuna-moeqf-mix-bal-5e1-l1-st-1207 -i reg-ai.chehejia.com/ssai/lizr/cu118/py310/pytorch:2.0.1-multinode-nccl -p default
# PATH_ORI=${0%/*}
...
run:
  ...
  seed: 42
  output_dir: "/mnt/pfs-guan-ssai/nlu/wanghanzi/experiments/blip2/vicuna7b/qformer_moe/mix_coco_gqa_balance_raw_QformerMoE_train_qf_train_qt_l2norm_weight_3ex_top1_1loss_textinqf_epo3_toplayer3_1206/"
