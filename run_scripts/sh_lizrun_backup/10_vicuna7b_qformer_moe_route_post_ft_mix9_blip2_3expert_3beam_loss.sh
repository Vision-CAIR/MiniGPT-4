...
# start: lizrun start -c "/mnt/pfs-guan-ssai/nlu/wanghanzi/multimodal/PromptMoE/9_vicuna7b_qformer_moe_route_post_ft_mix_llava_blip2_2expert_2beam.sh" -n 1 -j route-mixl-2e2b-2l-post-0112 -i reg-ai.chehejia.com/ssai/lizr/cu118/py310/pytorch:2.0.1-multinode-nccl -p default
# PATH_ORI=${0%/*}
...
run:
  ...
  seed: 42
  output_dir: "/mnt/pfs-guan-ssai/nlu/wanghanzi/experiments/blip2/vicuna7b/qformer_moe_route/mix_1048k_raw_QformerMoE_Route_Post_ffn_prob_linear_gate_2ex_2beam_1gate_2loss_6layer_lr5e5_textinqf_epo6_0112/"
