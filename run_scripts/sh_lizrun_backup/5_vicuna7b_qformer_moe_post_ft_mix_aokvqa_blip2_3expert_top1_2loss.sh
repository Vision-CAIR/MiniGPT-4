...
# start: lizrun start -c "/mnt/pfs-guan-ssai/nlu/wanghanzi/multimodal/PromptMoE/5_vicuna7b_qformer_moe_post_ft_mix_aokvqa_blip2_3expert_top1_2loss.sh" -n 1 -j post-aokvqa-3e1-cls-5e5-0307 -i reg-ai.chehejia.com/ssai/lizr/cu118/py310/pytorch:2.0.1-multinode-nccl -p basev
# PATH_ORI=${0%/*}
