...
# start: lizrun start -c "/mnt/pfs-guan-ssai/nlu/wanghanzi/multimodal/PromptMoE/7_vicuna7b_qformer_moe_route_pre_ft_mix_blip2_2expert_2beam_1loss.sh" -n 1 -j route-pre-mix-2ex2b-l1-0107 -i reg-ai.chehejia.com/ssai/lizr/cu118/py310/pytorch:2.0.1-multinode-nccl -p default
# start: lizrun start -c "/mnt/pfs-guan-ssai/nlu/wanghanzi/multimodal/PromptMoE/7_vicuna7b_qformer_moe_route_pre_ft_mix_blip2_2expert_2beam_1loss.sh" -n 1 -j route-pre-mix-2ex2b-l1-0107 -p mm
# PATH_ORI=${0%/*}
...
run:
  ...
  seed: 42
  output_dir: "/mnt/pfs-guan-ssai/nlu/wanghanzi/experiments/blip2/vicuna7b/qformer_moe_route/mix_coco_gqa_1610k_raw_QformerMoE_Route_Pre_ffn_prob_x_beamidx_linear_1gate_2ex_2beam_1loss_top6layer_textinqf_epo6_0107/"
