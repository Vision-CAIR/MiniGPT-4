...
# start: lizrun start -c "/mnt/pfs-guan-ssai/nlu/wanghanzi/multimodal/PromptMoE/5_vicuna7b_qformer_moe_post_ft_mix_aokvqa_cap_blip2_3expert_top1_001_2loss.sh" -n 1 -j post-ao-cap-3e1-5e5-001-0308 -i reg-ai.chehejia.com/ssai/lizr/cu118/py310/pytorch:2.0.1-multinode-nccl -p basev -t nvidia-a100-sxm4-80gb
...
run:
  ...
  seed: 42
  output_dir: "/mnt/pfs-guan-ssai/nlu/wanghanzi/experiments/blip2/vicuna7b/qformer_moe_post/mix_coco_gqa_aokvqa_raw_QformerMoE_linear_gate_lnout_lr5e5_3ex_top1_2loss_001_top6layer_textinqf_8epo_0308/"
