...
# start: lizrun start -c "/mnt/pfs-guan-ssai/nlu/wanghanzi/multimodal/PromptMoE/8_vicuna7b_qformer_moe_route_post_ft_mix_aokvqa_cap_blip2_3expert_3beam_2loss_lora.sh" -n 1 -j lora-r-post-mix5-3e3b-lnin-0312 -i reg-ai.chehejia.com/ssai/lizr/cu118/py310/pytorch:2.0.1-multinode-nccl -p sft
# PATH_ORI=${0%/*}
...
run:
  ...
  seed: 42
  output_dir: "/mnt/pfs-guan-ssai/nlu/wanghanzi/experiments/blip2/vicuna7b/qformer_moe_route/lora_mix_coco_gqa_ao_cap_raw_QformerMoE_Post_Route_linear_gate_lnin_lr5e5_3ex3b_2loss_005_top6layer_textinqf_8epo_0312/"
