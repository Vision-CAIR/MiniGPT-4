...
# start: lizrun start -c "/mnt/pfs-guan-ssai/nlu/wanghanzi/multimodal/PromptMoE/4_qformer_moe_ft_gqa_blip2_5expert_top1_2loss.sh" -n 1 -j blip2-qf-moe-gqa-5ex-a1-1105  -t nvidia-a800-sxm4-80gb -i reg-ai.chehejia.com/ssai/lizr/cu118/py310/pytorch:2.0.1-multinode-nccl -p default
# start: lizrun start -c "/mnt/pfs-guan-ssai/nlu/wanghanzi/multimodal/PromptMoE/4_qformer_moe_ft_gqa_blip2_5expert_top1_2loss.sh" -n 1 -j blip2-qf-moe-gqa-5ex-a1-1105 -g 4 -t nvidia-a100-sxm4-80gb -i reg-ai.chehejia.com/ssai/lizr/cu118/py310/pytorch:2.0.1-multinode-nccl -p default
# PATH_ORI=${0%/*}
...
run:
  ...
  seed: 42
  output_dir: "/mnt/pfs-guan-ssai/nlu/wanghanzi/experiments/blip2/flant5xxl/prompt_moe/gqa_943k_raw_QformerMoE_train_qf_train_qt_linear_gate_5ex_top1_2loss_textinqf_epo5_1104/"
